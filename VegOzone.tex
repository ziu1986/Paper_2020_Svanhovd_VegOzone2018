...
For comparison, the default values ($A_\mathrm{start} = 100\,\unit{doy}$ and $A_\mathrm{end} = 307\,\unit{doy}$) indicating a substantially longer growing season. Due to a lack of quantitative field observation, we assume a latency period of $1\,\unit{month}$ after snow-melt for perennial grassland \citep[][Supplement Fig.~S1, Rovaniemi]{FCR:Korhonen2018}. 
