...
\title{Ozone induced damage on vegetation in a subarctic climate: implications of Plant Functional Types on Phototoxic Ozone Dose modeling}
...
\begin{abstract}
  In the future, persitent heatwaves may occur more often. This
...
\begin{figure}[t]
  ...
  \includegraphics[width=8.3cm]{javis_funcs_f_light_grassland}
\caption{TEXT}
