...
\subsection{Implications on ozone damage risk}
\label{subsec:clim_risk}

As we have shown, 2019 was a rather normal year compared to 2018 with respect to present-day climate and ozone concentrations. In conjunction with the $\mathrm{DO_3SE}$ modeling results (Section~\ref{subsec:do3se_results}), this indicates that risk of ozone-induced damage in subarctic vegetation has been underestimated in assessments using the Boreal MM parameterizations. In future scenarios in which persistent heatwaves like in 2018 become more common, the risk for ozone-induced damage is probably reduced for vegetation adapted to cold growing conditions. A longer growing season promoted by climate change without weather extremes like in 2019 is likely to increase this risk.
