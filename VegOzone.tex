...
We have modeled $\mathrm{POD_y}$ with a flux threshold $y=1\,\unit{nmol\,m^{-2}\,s^{-1}}$ per projected leaf area (PLA) for three natural/semi-natural vegetation types, downy birch, Norway spruce, and perennial grassland using both MM parameterizations and a variaty of bespoke response function in $f_\mathrm{T}$ and $f_\mathrm{light}$, and localized GS (described in detail in Section~\ref{subsec:do3se_parameters}). The results are shown comprehensively in Fig.~\ref{fig:pody_rel}. For comparison, critical levels for a $4\,\unit{\%}$ (silver birch), $2\,\unit{\%}$ (Norway spruce), and $10\,\unit{\%}$ (perennial grassland, above ground) reduction in biomass \citep{ICP:MappingManual2017,ESPR:Hayes2021} are shown as horizontal dashed lines. Different years are color coded as previously. Simulations with MM GS, canopy, and leaf parameters are indicated with squared markers, bespoke GS with circles. The annotation $\pm$ refers to bespoke light response function threshold ($+$ increased, $-$ decreased), while bespoke temperature response functions are indicated by categories on the x-axis. Closed/open symbols represent SWP sensitivity switched off/on in the model.

The results depicted in Fig.~\ref{fig:pody_rel} allow for a comprehensive assessment of a large variety of systematic uncertainties in the exposure-based risk metric for ozone induced damage in subarctic vegetation. In summary, we identify the following main effects on the model predicted ozone uptake with respect to MM default parameterization:
\begin{itemize}
  \itemsep0pt
\item Increasing temperature acclimation $\rightarrow$ increased uptake regardless of individual year,
...
\item lower/higher light threshold $\rightarrow$ incresed/reduced uptake,
\item bespoke light threshold $\rightarrow$ asymmetric response in POD,
\item temperature acclimation $\rightarrow$ amplified effect of light threshold and drought.
\end{itemize}
The exact order of magnitude of these effects varies for individual species or PFT and between years, but the thus predicted ozone uptake is in any case larger than for MM default parameterizations. This indicates a considerable underestimation of ozone risk for subarctic species. Drought effects (SWP) do only matter if a bespoke GS is not taken into account.

In more detail for downy birch (Fig.~\ref{fig:pody_rel}a) all simulations exceed the CL by $5-25\,\unit{mmol\,\chem{O_3}\,m^{-2}}$. Downy birch displays the largest range of ozone uptake among all species or PFTs ($10-31\,\unit{mmol\,\chem{O_3}\,m^{-2}}$). In particular, the sensitivity to the light threshold is especially pronounced, e.g. $\Delta\mathrm{POD_1} = ^{+2.5}_{-3.6}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in case of boreal type without bespoke GS in 2019. Without bespoke GS 2018 stands out as a higher ozone damage risk year compared to 2019. However, taking the later onset and overall shorter GS in 2018 into account, this is reversed for the boreal acclimation type. SWP induced reduction in ozone uptake is only effectiv in 2018 and without bespoke GS. The overall bias deduced from bespoke GS for boreal and cold with respect to MM ranges between $(1.4-3.6)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 and $(2.7-7.7)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2019 with maximum systematic uncertainties due to light acclimation of $^{+1.6}_{-2.3}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and $^{+1.9}_{-2.7}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$, respectively. 

For Norway spruce (Fig.~\ref{fig:pody_rel}b), most simulations slightly exceed the CL ($0-10\,\unit{mmol\,\chem{O_3}\,m^{-2}}$). Norway spruce is the least sensitive to acclimation in temperature and therefor the least biased. Norway spruce displayes a medium sensitivity to the light threshold, e.g. $\Delta\mathrm{POD_1} = ^{+1.7}_{-1.3}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in case of boreal type without bespoke GS in 2018. Taking the bespoke GS into account, we find a higher ozone uptake in 2019 for all bespoke temperature response functions. The overall bias deduced from bespoke GS for boreal and cold types with respect to MM ranges between $(0.5-1.0)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 and $(2.0-3.3)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2019 with maximum systematic uncertainties due to light acclimation of $^{+1.0}_{-0.8}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and $^{+1.3}_{-1.0}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$, respectively.

For perennial grassland (Fig.~\ref{fig:pody_rel}c), all simulations with bespoke GS stay below the CL. Perennial grassland shows the smallest ozone uptake, but a similarily large bias as downy birch. We also find a reversal for predicted ozone damage risk in $\mathrm{POD_1}$ between 2018 and 2019 for the boreal type. Perannial grassland shows the lowest sensitivity to the light threshold and SWP is only relevant without bespoke GS. The overall bias deduced from bespoke GS for boreal and cold types with respect to MM ranges between $(2.2-3.4)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 and $(4.4-6.4)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2019 with maximum systematic uncertainties due to light acclimation of $^{+0.3}_{-0.2}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and $^{+0.3}_{-0.3}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$, respectively.

\begin{figure}[t]
  \includegraphics[width=8.3cm]{fig11}
  \caption{$\mathrm{DO_3SE}$ modeling results for $\mathrm{POD_1}$ with default parameterization (MM) and bespoke parameters for Svanhovd. Bespoke parameterizations include temperature response functions for boreal, cold and light thresholds (PPFD0.8, PPFD1.2) at the end of a MM GS (lighter hue and dotted lines) and the estimated GS for Svanhoved (2018, 2019). (a) Downy birch; (b) Norway spruce; (c) Perennial grassland. The dashed horizontal lines indicate critical levels defined in \citet{ICP:MappingManual2017,ESPR:Hayes2021} for each species, respectively.}
  \label{fig:pody_rel}
\end{figure}


The estimated biomass reduction in \unit{\%} due to \chem{O_3} for bespoke type boreal in accordance to \citet{ICP:MappingManual2017, ESPR:Hayes2021} is shown in Table~\ref{tab:biomass_reduction}. The estimated uncertainies correspond to a $\pm 20\,\unit{\%}$ variation in light threshold and SWP=on. {\bf TODO: Lisa? Add paragraph about biomass reduction to introduction?}

\begin{table}[t]
  \caption{Estimated total biomass reduction in \unit{\%} due to \chem{O_3} for bespoke type boreal. Uncertainies correspond to a $\pm 20\,\unit{\%}$ variation in light threshold and SWP=on.}
...
\middlehline
2018 & $15.5^{+(1.9...2.1)}_{-(0.8...1.5)}$ & $2.5^{+(0.2)}_{-(0.2)}$ & $9.7^{+(0.2)}_{-(0.2)}$ & $^*13.1^{+(0.3)}_{-(0.3)}$\\
2019 & $17.4^{+(2.5)}_{-(1.8)}$ & $3.0^{+(0.2)}_{-(0.3)}$ & $10.5^{+(0.1...0.2)}_{-(0.0...0.1)}$ & $^*14.5^{+(0.2...0.3)}_{-(0.1...0.3)}$\\
\bottomhline
\end{tabular}
...
\item Lower/higher light threshold $\rightarrow$ incresed/reduced uptake.
\end{itemize}
The exact order of magnitude of these effects varies for individual species or PFT and between years, but the thus predicted ozone uptake is in any case larger than for MM default parameterizations. This indicates a considerable underestimation of ozone risk for subarctic species.
 The impact of the timing of the GS can be at the same oder of magnitude as the acclimation of response function but points into the oposite direction. Especially, the timing of $A_\mathrm{start}$ with respect to the ozone spring peak induces large uncertainties in anticipation of an acclimation to colder climates. 
...
\begin{figure*}[t]
  ...
  \caption{$\mathrm{DO_3SE}$ modeling results for mapping manual default parameterazation. $\mathrm{POD_y}$ is shown over day of year (\unit{doy}), March--October. A flux threshold $y=1\,\unit{nmol\,m^{-2}\,s^{-1}}$ per projected leaf area (PLA) has been chosen. \chem{[O_3]} are plotted on the same axis and scales as $G_\text{sto}^\text{leaf}$ but in units of $\unit{ppb}$. (a, b) Downy birch; (c, d) Norway spruce; (e, f) perennial grassland. From left to right: 2018, 2019.}
