...
All surface ozone observations used in this study are available from NILU EBAS database. Data for the 2018/19 growing season at Svanhovd have not yet been made available \emph{alternative: shall be made available at a later point}. In Table~\ref{tab:ebas_obs}, we give an overview over the exact locations and time range of operational data taking. 
