...
The research station at Svanhovd comprises long-term observations of various agrameteorological variables, i.a. $2\,\unit{m}$ temperature, precipitation, global irradiance, and soil moisture and temperature at different depths.

For the purpose of relating observed damage on ozone sensitive plants (e.g. clover and tobacco) an ozone monitor had been installed during the growing seasons 2018/19. The relevant data are described in more detail Section~\ref{subsubsec:atmo_svanvik}.
...
All agrameterological variables including temperature and precipitation are available from approximately 1992 to present day from LandbruksMeteorologisk Tjeneste provided by NIBIO (\href{https://lmt.nibio.no/}{lmt.nibio.no}, note the station name here is Pasvik).
...
\label{subsubsec:ozone_garden}
      {\bf TODO: Details about the ozone garden.} \emph{Author: Ane/Aud -- pictures are welcome, just upload them on overleaf or send them.}



\subsection{Other data}
\label{subsec:obs_data}
To determine the significance of the conditions in 2018, we are interested not only in present (2018/19) surface ozone concentrations at Svanvik but also in long term observations and a climatology derived thereof. While data for the period 1986--1996 exists for Svanvik, no ozone measurements have been conducted at Svanhovd for the past $14\,\unit{years}$. Hence, we also have to have a look at ozone observations at other sites in northern Fennoscandia. In regard to ozone, available observational data are limited to a handful of atmospheric monitoring sites. An overview over their geographical locations is given in Fig.~\ref{fig:station_map_fennoscandia}. The data is descibed in Section~\ref{subsubsec:ebas}. 
As additional complement to observational data which was not available at all times or spatially sparse, we also look at verious ozone reanalysis products (Section~\ref{subsubsec:ozone_rea}).
...
All surface ozone observations used in this study are available from the EBAS database operated by NILU (\href{http://ebas.nilu.no/}{ebas.nilu.no}). In Table~\ref{tab:ebas_obs}, we give an overview over the exact locations and time range of operational data taking.
Note that from 1986--1996, ozone monitoring has been conducted operationally by NILU at Svanhovd.
...
\begin{figure}[t]
  ...
  \caption{Temperature at Svanvik. Percentage of days warmer/colder than $\pm 1\,\sigma$ from climatological mean displayed for each month. (a) 2018; (b) 2019. Negative deviations from climatology are shown as negative percentage. The annual positive/negative deviations are indicated in the respective corners (right upper/ right lower). The summer of 2018 was significantly warmer than average, especially May and July. The summer of 2019 was fairly average but significantly warmer than average in April and colder in July/August.}
  \label{fig:plot_temperature_anomalies_svanvik}
\end{figure}

\begin{figure}[t]
  \includegraphics[width=8.3cm]{precipitation_signific}
  \caption{Precipitation at Svanvik. Percentage of days wetter/drier than $\pm \frac{1}{2}\,\sigma$ from climatological mean displayed for each month. (a) 2018; (b) 2019. Negative deviations from climatology are shown as negative percentage. The annual positive/negative deviations are indicated in the respective corners (right upper/ right lower). The summer of 2018 was significantly drier than in 2019.}
  \label{fig:plot_precipitation_anomalies_svanvik}
\end{figure}

\begin{figure}[t]
  \includegraphics[width=8.3cm]{global_rad_signific}
  \caption{Global irradiance at Svanvik. Percentage of days above/below $\pm 1\,\sigma$ from climatological mean displayed for each month. (a) 2018; (b) 2019. Negative deviations from climatology are shown as negative percentage. The annual positive/negative deviations are indicated in the respective corners (right upper/ right lower). In summer 2018 (May/July), gobal irradiance was significantly higher than on average, while 2019 was generally an average year.}
