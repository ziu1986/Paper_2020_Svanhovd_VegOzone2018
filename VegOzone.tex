...
\end{itemize}
The exact order of magnitude of these effects varies for individual species or PFT and between years, but the predicted ozone uptake for the bespoke parameterization is in any case larger than for the MM default parameterizations. This indicates a considerable underestimation of ozone risk for subarctic species. Drought effects (SWP) do only matter if a bespoke GS is not taken into account. We will look at the specific species or PFTs in more detail in the following.

For downy birch (Fig.~\ref{fig:pody_rel}a) all simulations exceed the CL by $5-25\,\unit{mmol\,\chem{O_3}\,m^{-2}}$. Downy birch displays the largest variance of ozone uptake among all species or PFTs ($10-31\,\unit{mmol\,\chem{O_3}\,m^{-2}}$). In particular, the sensitivity to the light threshold is especially pronounced, e.g. $\Delta\mathrm{POD_1} = ^{+2.5}_{-3.6}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in case of the boreal type without bespoke GS in 2019. Without bespoke GS, 2018 stands out as the year with the higher ozone damage risk than 2019. However, taking the later onset and overall shorter GS in 2018 into account, this is reversed for the boreal acclimation type. SWP induced reduction in ozone uptake is only effective in 2018 and without bespoke GS. The overall bias deduced from bespoke GS for boreal and cold with respect to MM ranges between $(1.4-3.6)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 and $(2.7-7.7)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2019 with maximum systematic uncertainties due to the variation of the light threshold of $^{+1.6}_{-2.3}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and $^{+1.9}_{-2.7}\,\unit{mmol\,\chem{O_3}\,m^{-2}}$, respectively. 
...
\item temperature acclimation $\Rightarrow$ amplifying effect on light threshold and drought.
\end{itemize}
The exact order of magnitude of these effects varies for individual species or PFTs and between years. Thus predicted ozone uptake is XSlarger than for MM default parameterizations. This indicates a considerable underestimation of ozone risk for subarctic species.
