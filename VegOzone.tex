...
Beyond the risk assessment of ozone induced damage, our hypothetical bespoke temperature response function may have important indications for land-surface modeling, where problems in productivity of species especially in the Arctic regions occur due to PFTs which are not suitable for the climate. We pointed out with respect to default perennial grassland parameterization that that did not show any substantial stomatal conductance in 2019 which we characterized as a normal year. In terms of GPP this would mean unrealistically low carbon sequestration. An automation of the here proposed PDF-based acclimation using machine learning techniques could overcome these issues in the future.
