...
We estimated the biomass reductions in accordance to the CLs \citep{ICP:MappingManual2017, ESPR:Hayes2021} for the most extreme temperature parameterization (\emph{subarctic}) for each bespoke PFT. The estimates are listed in Table~\ref{tab:biomass_reduction}. The reported range corresponds to the maximum deviation defined by the $\pm 20\,\unit{\%}$ variation of $f_\mathrm{light}$ with SWP=on. Total biomass of deciduous trees and perennial grassland was substentially reduced in comparison with the default MM parameterizations in both years. The CL for perennial grassland is higher than for the other species. From an agro-economical point of view in our focus area, where grass is cut only once a year, a loss of biomass of more than $10\,\unit{\%}$ can have severer consequences compared to more productive areas in central Europe and may need adjustment.
...
\authorcontribution{All authors contributed to framing this research article, writing, and conclusions. SF has written the manuscript, collected and processed ozone and environmental data, and performed all statistical analyses. AVV has performed the on-site observation of vegetation damage induced by ozone, provided advice on plant physiological processes, collected exisiting literature on subarctic vegetation, contributed significantly to framing and proof reading this research article. LE has contributed with expertize in $\mathrm{DO_3SE}$ modeling and development of the PDF-based temperature acclimation assessment. CO has collected PFT parameters from the literature, performed all $\mathrm{DO_3SE}$ simulations and validation. AE contributed with her experience regarding subarctic vegetation in Finnmark. FS contributed with an assessment of the 2018 meteorological conditions and writing the proposal for founding this project. TB gave valuable guidance in a broader research sense.} %% this section is mandatory
