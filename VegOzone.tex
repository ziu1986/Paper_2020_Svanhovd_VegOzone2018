...
We have modeled $\mathrm{POD_y}$ (flux threshold $y=1\,\unit{nmol\,m^{-2}\,s^{-1}}$ per projected leaf area (PLA)) for three natural/semi-natural vegetation types, downy birch, Norway spruce, and perennial grassland using both MM parameterizations and a variaty of bespoke parameterizations in $f_\mathrm{T}$, $f_\mathrm{light}$, and GS (described in detail in Section~\ref{subsec:do3se_parameters}). The results are shown comprehensively in Fig.~\ref{fig:pody_rel}. For comparison, critical levels (CLs) for a $4\,\unit{\%}$ ($2\,\unit{\%}$ for Norway spruce) reduction in biomass in accordance to \citet{ICP:MappingManual2017} are shown as horizontal dashed lines. Different years are color coded. Lighter hue indicates simulations with MM GS and MM canopy and leaf parameters. Annotated $\pm$ refers to bespoke light response functions, while bespoke temperature response functions are indicated by categories on the x-axis. Closed/open symbols represent SWP sensitivity switched off/on in the model.

For downy birch (Fig.~\ref{fig:pody_rel}a), all simulations exceed the CL by $5-25\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and display the largest spread among the species ($16\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 for boreal type). As expected, SWP reduces ozone uptake in 2018 mainly. The uncertainty induced by the light sensitivity threshold ranges between $(1.5..2.5)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ and $(-2.2..-3.6)\,\unit{mmol\,\chem{O_3}\,m^{-2}}$. With MM GS, 2018 displays increasingly larger ozone uptake than 2019 with more acclimated paramters. However accounting for the shorter and later GS in 2018, we find a reversal of this relationship in the boreal type. We deduce an overall systematic uncertainty of $xx$.

For Norway spruce (Fig.~\ref{fig:pody_rel}b), most simulations exceed the CL ($0-10\,\unit{mmol\,\chem{O_3}\,m^{-2}}$). Norway spruce displays an overall lower spread ($10\,\unit{mmol\,\chem{O_3}\,m^{-2}}$ in 2018 for boreal type) than downy birch, but appears more sensitive to GS and interannual veriability in conditions (boreal GS MM compared to GS bespoke). The sensitivity to the light threshold is also smaller compared to downy birch. Accounting for the shorter and later GS in 2018, we find again a reversal between predicted ozone damage in 2018 and 2019 for the boreal type. We deduce an overall systematic uncertainty of $xx$.

For perennial grassland (Fig.~\ref{fig:pody_rel}c), all simulations with bespoke GS stay below the CL. CL is only exceeded for boreal types and cold type in 2018. We find the same reveral between 2018 and 2019 as for the other species in the boreal type. Perannial grassland shows the lowest sensitivity to the light threshold and SWP is only relevant for the MM GS. The spread in 2018 for boreal type is of the order of $10\,\unit{mmol\,\chem{O_3}\,m^{-2}}$. We deduce an overall systematic uncertainty of $xx$.

These results allow for an assessment of a large variety of systematic uncertainties in the exposure-based risk metric for ozone induced damage in subarctic vegetation. In summary, we identify the following main effects on the model predicted ozone uptake:
\begin{itemize}
\item Optimal acclimation of species or PFT $\rightarrow$ increased uptake in any year,
\item Identification of proper timing of the growing season $\rightarrow$ reduced uptake in any year,
\item Drought conditions $\rightarrow$ reduced uptake,
\item Early onset of growing season $\rightarrow$ increased uptake.
\end{itemize}
The exact order of magnitude of these effects varies with species or PFT and from year to year. The systematic uncertainty induced by our proposed temperature acclimation is, in general, larger than for a $\pm 20\,\unit{\%}$ variation in light response threshold and can likely exceed $xx\,\unit{\%}$ for some years and species. This would lead to a huge underestimation of induced ozone damage. At the same time, the magnitude of light response uncertainty is increasing with acclimation to colder temperature. The impact of the timing of the GS can be at the same oder of magnitude as the acclimation of response function but points into the oposite direction. Especially, the timing of $A_\mathrm{start}$ with respect to the ozone spring peak (compare 2018 GS MM and GS bespoke) induces large uncertainties which are increasing if an acclimation to colder climate is anticipated. 


\begin{figure}[t]
  \includegraphics[width=8.3cm]{fig11}
  \caption{$\mathrm{DO_3SE}$ modeling results for $\mathrm{POD_1}$ with default parameterization (MM) and bespoke parameters for Svanhovd. Bespoke parameterizations include temperature response functions for boreal, cold and light thresholds (PPFD0.8, PPFD1.2) at the end of a MM GS (lighter hue and dotted lines) and the estimated GS for Svanhoved (2018, 2019). (a) Downy birch; (b) Norway spruce; (c) Perennial grassland. The dashed horizontal lines indicate the critical levels defined in \citet{ICP:MappingManual2017} for each species, respectively.}
  \label{fig:pody_rel}
\end{figure}
...
\begin{figure*}[t]
  ...
  \caption{$\mathrm{POD_y}$ modeling results from $\mathrm{DO_3SE}$ model for three different PFTs over day of year (\unit{doy}), March--October. A flux threshold $y=1\,\unit{nmol\,m^{-2}\,s^{-1}}$ per projected leaf area (PLA) has been chosen. \chem{[O_3]} are plotted on the same axis and scales as $G_\text{sto}^\text{leaf}$ but in units of $\unit{ppb}$. (a, b) Birch; (c, d) Norway spruce; (e, f) perennial grassland. From left to right: 2018, 2019. {\bf TODO: substitute with figure for Boreal PFTs?}}
