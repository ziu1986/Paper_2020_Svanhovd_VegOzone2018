...
\subsubsection{EBAS database}
\label{subsubsec:ebas}

\begin{table}[t]
  \caption{Ozone observations in northern Fennoscandia available from EBAS.}
  \label{tab:ebas_obs}
...
\bottomhline
\end{tabular}
\belowtable{$^\dagger$ Exclusive data taking summer seasons 2018/19.} % Table Footnotes
\end{table}
