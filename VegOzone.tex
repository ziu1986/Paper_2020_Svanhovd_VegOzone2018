...
\begin{figure*}[t]
  ...
  \caption{Observational data from atmospheric monitoring at Svanhovd in 2018/19. The hatched areas indicate missing ozone monitoring data. (a) Ozone; (b) temperature; (c) daily accumulated precipitation.}
...
All surface ozone observations used in this study are available from NILU EBAS database except for the data for the 2018/19 growing season at Svanhovd. In Table~\ref{tab:ebas_obs}, we give an overview over the exact locations and time range of operational data taking. 
