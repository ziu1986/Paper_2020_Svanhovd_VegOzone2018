...
The opening of stomata is governed by different species-specific factors and response to key environmental variables. In $\mathrm{DO_3SE}$ it is described by a multiplicative empirical model \citep{PTRS:Jarvis1976,Emberson2000,ICP:MappingManual2017}:
\begin{equation}
