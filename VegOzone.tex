...
\begin{table}[t]
  ...
  \begin{tabular}{lllllrl}
    ...
    \bottomhline
  \end{tabular}
  \belowtable{$^1$ Data available until the end of 2018.\\
    $^2$ Data available until the end of 2019.\\
...
\begin{figure*}[t]
  ...
  \caption{Time series of ozone observations in northern Fennoscandia (Tab.~\ref{tab:ebas_obs}) (1986--2019). Data taken from EBAS. The hatched areas indicate time periods with insufficient quality control \citep{NILU2003}. {\bf TODO: updata with recent Pallas data}}
