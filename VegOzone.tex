...
{\bf TODO: Some more general information about the research station? E.g., what NIBIO us currently researching there, that it also hosts a conference site, and national park center.}
...
Ozone concentrations \chem{[O_3]} measured in $2\,\unit{m}$ height above ground are averaged hourly. As can be seen in Fig.~\ref{fig:data_svanvik_2018_2019}a), \chem{[O_3]} peaks in spring (April/May) and reaches its minimum in late summer (July/August). The spring peak has not been captured in 2019, for data acquisition started later than in 2018. In 2018, high summer ozone concentrations ($\chem{[O_3]}> 40\,\unit{ppb}$) were observed in July. A part of these peak values may, however, coincident with the time period of missing data. In the summer of 2019, ozone concentrations stayed below the threshold of $40\,\unit{ppb}$.
...
To determine the significance of the ozone conditions in 2018, we have to derive a surface ozone concentration climatology at Svanvik. From 1986--1996 ozone monitoring has been operated by NILU at Svanhovd, but no ozone measurements have been conducted for the past $14\,\unit{years}$. Due to probabel changes in tropospheric background ozone and a reduction of summertime peak values related to precursor that fell under airquality regulations, we also have to have a look at ozone observations at other sites in northern Fennoscandia. In regard to ozone, available observational data are sparse in this region. An overview over the geographical locations of conducted atmospheric monitoring in past and present is given in Fig.~\ref{fig:station_map_fennoscandia}. The data is descibed in Section~\ref{subsubsec:ebas}. 
...
\begin{figure}[t]
  ...
  \caption{Climate diagram following Walter and Lieth. The diagram is based on climatological data for Svanvik/Pasvik (1992--2017) downloaded from LandbruksMeteorologiske Tjeneste. Monthly average temperatures (red line) are displayed with standard error of mean as error band. Average monthly accumulated precipitation (blue bars) is shown with standard deviation of mean as error bars. Months with average temperatures below freezing are denoted with a star.}
...
\begin{figure}[t]
  ...
  \caption{Observed global irradiance at Svanvik. The grey lines indicate the $1\,\sigma$ level deducted from the climatology. (a) Climatology (hourly maxima, mean, and minima); deviation from climatology (b) 2018; (c) 2019.}
