...
The opening of stomata, typically quantified through a conductance to water vapor $g_\mathrm{sto}$, is governed by different environmental factors and is described by a multiplicative ansatz \citep{PTRS:Jarvis1976,ICP:MappingManual2017}:
\begin{equation}
...
\authorcontribution{SF has written the manuscripted, collected and processed ozone and environmental data, and performed all statistical analyses. AVV has performed on-site observation of vegetation demage induced by ozone and contributed to theory of ozone interaction with vegetation within the introduction. LE... CO... ALEB...  FS... TB... All authors contributed to discussion and conclusion of the results.} %% this section is mandatory
