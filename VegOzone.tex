...
\begin{figure}[t]
  \includegraphics[width=8.3cm]{ozone_reconstruction_2018_07}
  \caption{Reconstruction of missing \chem{[O_3]} observation data at Svanhovd in July 2018 based on derived hourly climatologies of northern Fennoscandia, Svanvik, and data Pallas. (a) Time series; (b) anomalies; (c) reconstruction.}
