...
\item future climate and conditions
  ...
  \item[$\rightarrow$] increase in tropospheric background ozone
  \end{itemize}
\item meteorological situation 2018
\end{itemize}
...
In our assessment on ozone damage on vegetation is the subarctic in relation to the 2018 heatwave, we focus on the NIBIO operated local site Svanhovd which lies close by the settlement of Svanvik in the Pasvik valley. For the purpose of this study, we evaluate data taken at Svanhovd with observational data (Section~\ref{subsec:svanhovd}) with different monitoring sites in northern Fennoscandia (Section~\ref{subsec:obs_data}). Reanalysis data is used for complementation were observational data was not available or temporally sparse (Section~\ref{subsec:model_data}).
...
\label{subsubsec}
{\bf TODO: (Technical) details about ozone monitoring at Svanhovd - historical periode. Project related monitoring (summer seasons 2018/19.) $\rightarrow$ NILU -- Sverre?}
...
For the purpose of this study, we are interested in past and present observations of surface ozone concentrations in northern Fennoscandia. This limits the available observation data to a handfull of atmospheric monitoring sites with data available from the NILU EBAS database. An overview over the geographical locations is given in Fig.~\ref{fig:station_map_fennoscandia}.

\begin{figure}[t]
  \includegraphics[width=8.3cm]{station_map_fennoscandia}
  \caption{Cap of the North. Location of past and present ozone observation sites in northern Fennoscandia used within this study.}
...
\begin{table}[t]
  \caption{Past and present ozone observation sites in northern Fennoscandia. Data available on EBAS.}
  \label{tab:ebas_obs}
...
\begin{figure*}[t]
  ...
  \caption{Time series of ozone observations in northern Fennoscandia. Data taken from EBAS as well as from dedicated ozone monitoring at Svanhovd in the summer seasons 2018/19 (Tab.~\ref{tab_ebas_obs}). The hatched areas indicate time periods with insufficient quality control - \bf{TODO: citation NILU ozone report 200x}.}
\end{figure*}
...
Range of reanlysis data.
\subsubsection{Ozone}

\begin{table}[t]
\caption{Ozone related ranalysis products used in this study: \href{https://www.ecmwf.int/en/newsletter/158/meteorology/new-cams-global-reanalysis-atmospheric-composition}{Global reanalysis (ECMWF)}; \href{https://www.regional.atmosphere.copernicus.eu/}{ensemble mean of regional reanalysis for Europe (Copernicus)}.}
\begin{tabular}{llccl}
\tophline
...
\bottomhline
\end{tabular}
\belowtable{$^\dagger$ Subset of the data used in this study. The full dataset extends into near real time.} % Table Footnotes
\end{table}

Ozone: MACC-rea, CAMS-rea, Copernicus European regional model rea ensemble mean
