...
\begin{abstract}
The subarctic region is likely to be at threat from the combined impacts of climate change and ozone pollution due to its unique atmospheric mixing characteristics (which lead to peak ozone concentrations in spring), the influence of the jet stream on regional climate, and its unique vegetation bio-types that are acclimatized to extremes of cold and midnight sun. Unfortunately, to date, only a very few studies have been conducted to assess the response of vegetation to variations in climate and air pollution profiles, at least by comparison with other parts of Europe. This study looks to fill this knowledge gap by examining trends in climate variables and ozone pollution that have occurred over the past few decades. These climatological and ozone data are used to assess the extent to which two recent years (2018 and 2019) deviate from climatic and pollution norms and how these current (and potentially more frequent future) deviations may influence ozone damage to subarctic vegetation. To this end, the quality of available global and regional ozone reanalysis products for Europe is assessed. The analysis suggests that only the CAMS Regional Air Quality (CAMSRAQ) reanalysis ensemble sufficiently reproduces the observed seasonal cycle while systematically underestimating \chem{O_3} concentration in the region. We find that 2018 is an anomalous warm and bright year (in particular in spring and early summer) with higher than average \chem{O_3} concentrations in April/May and a high number of episodic peak \chem{O_3} concentration above $40\,\unit{ppb}$ in June--August, the latter in part attributable to an increase in forest fires in the Northern Hemisphere as well as warmer and sunnier conditions. We apply a flux-metric to determine ozone risk and damage to vegetation as a function of ozone concentration, climate variables, and species-specific physiology. We find that parameterization of this flux-metric for subarctic vegetation bio-types increases estimates of ozone-induced reduction of total biomass by between $2.5$ and $17.4\,\unit{\%}$ suggesting that the UNECE LRTAP assessments that use generic parameterizations would underestimate ozone risk in this region. We conclude that appropriate parameterization for the growing season, and plant physiological responses to light and temperature are particularly important for accurate modeling of seasonal gas exchange and that efforts should be targeted towards accurately defining subarctic bio-type physiological response to climatic variables to improve regional and global scale biogeochemical cycling under current and future climates.
\end{abstract}
