...
Flux-based methods of risk assessment rely on accurate representation of plant physiological responses to key environmental variables and are most often parameterized using data for less extreme climates, i.e., temperate, continental, or Boreal climates. Parameterization for more extreme bio-geographical regions such as subarctic climates has not been performed and relies on assuming that Boreal parameterization will be applicable. In our study, we explore how risk might be over- or underestimated using Boreal parameterization and explore a local climate derived temperature response function. We also study the impact of the opening extent of stomata at low light intensities (light response function).\\
