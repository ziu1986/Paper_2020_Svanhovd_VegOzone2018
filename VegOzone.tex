...
The correlation of \chem{[O_3]} between Esrange, Pallas, and Jergul/Karasjok is faily high (Fig.~\ref{fig:density_distribution}a, b), hence we can put those data series together to derive a general ozone climatology for northern Fennoscandia at similar altitudes. In Figure~\ref{fig:ozone_climatology_fenoscandic_obs_spline}, the 2 dimensional density distributions for both, the thus defined northern Fennoscandia (Fig.~\ref{fig:ozone_climatology_fenoscandic_obs_spline}a) and Svanvik (Fig.~\ref{fig:ozone_climatology_fenoscandic_obs_spline}) are shown. Darker colors indicate higher prohablity to observe these values. On top of the density distributions, 10 days averages of daily mean, daily maximum, and daily minimum \chem{[O_3]} are displayed together with the $1 \sigma$ uncertainties. For the daily mean the standard error of mean is shown in addition (albeit hardly visible). From the northern Fennoscandic climatology, one can deduce several features. The maximum of the 10 days average minimum ozone concentration peaks about $20\,\unit{days}$ earlier than the average mean and average maximum concentrations. From minimum concentration to maximum concentration it takes about $8.5\,\unit{months}$ while from maximum to minimum it only takes about $4.5\,\unit{months}$. The maximum of the average maximum ozone concentration is at $52\,\unit{ppb}$ (late April) and the minimum of the average minimum ocurres at $15\,\unit{ppb}$ (beginning of September). The steep rise of \chem{[O_3]} in spring coincident with increasing temperatures as well as increase in global irradiance.
