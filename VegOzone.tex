...
We found representative ozone climatologies (multi-annual means) for northern Fennoscandia and Svanhovd based on surface ozone monitoring. To account for missing data from our 2018 record, we proposed a routine for gap filling of ozone observations following a Reynolds's decomposition into anomalies and climatology. We also assessed the quality of available global reanalysis (ECMWF MACC and CAM) and regional model reanalysis (Copernicus) near-surface ozone concentrations products and conclude that only the Copernicus product can sufficiently reproduce observed ozone concentrations in northern Fennoscandia.
