...
The \chem{\left<\Delta\left<[O_3]\right>\right>} derived for Svanvik in 2018 is slightly larger than for Esrange and Pallas. This could mean either that 2018 had been more exceptional at Svanvik or the Svanvik climatology may need a correction for increased tropospheric background ozone concentration. Based on the meteorological conditions, we may assume 2019 as an average year which would lead to a deduction of a constant bias of about $1.2\,\unit{ppb}$ in the Svanvik climatology. Daily \chem{\Delta_{present-past}\left<[O_3]\right>} from Esrange and Pallas, wherein present is defined as the average of 2010--2018 and past as the respective beginning of data taking until 1997, do not reveal a clear trend: We find for Esrange $(1.5\pm 3.1)\,\unit{ppb}$ and for Pallas $(-2.5\pm 3.7)\,\unit{ppb}$. Former is compatible with our assumed bias for the Svanvik climatology.
...
To investigate which of the evironmental factors lead to the observed ozone damage on clover and tobacco {\bf TODO: Ane confirm!} at Svanhovd, we have modeled the ozone uptake using the DO3SE model.
