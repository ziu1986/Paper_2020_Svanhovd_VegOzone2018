...
We found that 2018 was warmer, drier, and brighter than usual, while 2019 was a rather average year. Ozone was more enhanced in 2018 than 2019 due to large forest fires in Central Sweden. We derived localized temperature and light response functions for modeling $\mathrm{POD_1}$ and biomass reduction using the $\mathrm{DO_3SE}$ model and found that vegetation that is sensitive to warm temperatures could be less effected by ozone stress under heat stress conditions. On the other hand, vegetation that thrives better in a warmer climate could be more effected by coincident elevated $\chi_{O_3}$.

The qualitative bio-monitoring study which we conducted at Svanhovd along conventional ozone monitoring showed more visible ozone damage on clover and tobacco in 2018. In contrast, no such damage was found on the clovers in 2019. However, visible damage is not necessarily related to the modeled reductions in biomass.

Our study shows that it could be essential for ozone risk assessments in the subarctic to take the proper plant physiology into account as the difference in biomass reduction compared to the usually used parameterizations could amount to $55\,\unit{\%}$ (deciduous trees). We found an above ground biomass reductuion in perennial grassland of well above $10\,\unit{\%}$. From an agro-economical point of view in our focus area, where the grass is cut only once a year, a loss of biomass of more than $10\,\unit{\%}$ can have severer consequences compared to more productive areas in central Europe. Therefore, CL may also need localization.
