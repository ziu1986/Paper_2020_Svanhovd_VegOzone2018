...
\begin{figure}[t]
  \includegraphics[width=12cm, clip, trim=1cm 0 1cm 1cm]{climatediagram_box}
  %\includegraphics[width=8.3cm]{fig04}
  \caption{Climate diagram. The diagram is based on climatological data for Svanvik/Pasvik (1992--2012). (a) Monthly temperatures. (b) Monthly accumulated precipitation.}
...
\subsection{Derivation from climate norm in the 2018/19 growing season}
...
\section{Modeling results and implications on ozone risk assessments}
