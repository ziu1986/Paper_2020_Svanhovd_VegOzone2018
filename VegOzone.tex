...
\label{sec:conc}
We have examplarily studied the effect of acclimations of biomes to a subarctic climate on phyto-toxic ozone uptake. We also assessed implications on potential ozone damage risks arising at the advant of climate change. We found that conditions for ozone formation were more favourable in the 2018 growing season than in 2019, with 2018 being significantly warmer and less cloudy in spring and early summer. Accordingly, peak ozone concentrations occured more frequently and at higher concentration levels in 2018. This was in particular caused by the extended heatwave in spring and early summer over whole Fennoscandia and associated, extensive wildfires esecially in Central Sweden (mid--end July).

The timing and trend in the onset of growing season may differ substantially between individual species in comparison to the thermal or latitudinal estimated growing season. Species-specific methods to estimate the onset \citep{IVL:Karlsson2018} show a later onset for European silver birch and earlier for Norway spruce, compared to the thermal growing season estimate. Based on MODIS data, we estimated the growing season in 2018 to be at least one month shorter than in 2019 for Norway spruce, and half a month shorter for downy birch and perennial grassland, respectively.

We have proposed a routine for gap filling of ozone data following a Reynolds's decomposition into annomalies and climatology (mulit-annual mean). We also assessed the quality of available global (ECWMF MACC and CAM reanalysis) and regional (Copernicus) near-surface ozone concentrations products and conclude that only the Copernicus product can sufficiently reproduce observed ozone concentrations in northern Fennoscandia.

Although high and more frequent ozone peak concentrations were observed in 2018, ozone concentrations were not significantly elevated by statistical means. It therefor occurs that weather conditions and constantly high ozone concentration are more important in risk assessment using flux-based metrices like $\mathrm{POD_y}$ than episodes of peak concentrations over shorter periodes of time. Consequently, accute cellular damage caused by a very high fluxes over a short periode of time is not accounted for properly in $\mathrm{POD_y}$. As pointed out by \citet{AE:Musselman2006}, a higher temporal resolution, e.g. higher susceptibility to ozone depending on leaf age, in the associated damage functions might give a more differenciated picture.

Besides a currently missing coupling to photosynthesis or nutrient cycle, ozone inflicted damage on stomatal conductance is also not accounted for in the $\mathrm{DO_3SE}$ model. Cumulative ozone uptake has been reported to reduce stomatal conductance significantly \citep[e.g.]{BGS:Lombardozzi2012} and subsequently reduces uptake of ozone. On the other hand, an ozone induced sluggishness \citep{SR:Hoshika2015} renders stomata inapt to fully close and would lead to increased ozone uptake. The presented $\mathrm{POD_y}$ may therefor be regarded as an upper limit.
...
We defined hypothetical temperature response functions representing different levels of species assumed acclimation to cold climates. We assume the acclimation to increase the enclosed area between probability density function and the respective response function. These hypothetical species or PFTs still need varification by experiemental data. Our results, however, allowed for a comprehensive assessment of a large variety of systematic uncertainties in the exposure-based risk metric for ozone induced damage in subarctic vegetation. In particular, we identified the following main effects on the model predicted ozone uptake with respect to the default parameterization used in risk assessment:
\begin{itemize}
  \itemsep0pt
\item Increasing cold tolerance/heat intolerance $\Rightarrow$ increased uptake regardless of individual year,
\item usage of proper growing season $\Rightarrow$ reduced uptake with respect to the above,
...
Beyond the risk assessment of ozone induced damage, out hypothetical bespoke temperature reponse function may have important indications for landsurface modeling, where problems in productivity of species especially in the arctic regions occure due to PFTs which are not suitable for the climate. An automatition of the here proposed PDF-based acclimation using machine learning techniques could overcome these issues in the future.
