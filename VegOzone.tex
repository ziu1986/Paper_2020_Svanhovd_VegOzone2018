...
The use of subarctic parameterization suggests an improvement in risk assessment as POD values are increased compared to standard expectations; corroborated by evidence of visible injury in the Svanhovd ozone garden. We estimate a total biomass reduction in Norway spruce of $2.5-3\,\unit{\%}$, downy birch by $15.5-17.4\,\unit{\%}$ and an above ground biomass reduction in perannial grassland of $12.4-13.7\,\unit{\%}$.  
\end{abstract}
